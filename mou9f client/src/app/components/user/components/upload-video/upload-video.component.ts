...
import { VedioService } from '../../service/vedio_service/vedio.service'; 
...
export class UploadVideoComponent implements OnInit {
  ...
  btndisabledupload: boolean = false;
  errorMessage: string = '';
  ...
  constructor(
    ...
    private videoService: VedioService,  // Service pour l'upload
   ...
   */
  canSubmit(): boolean {
    return this.uploadForm.valid && !!this.selectedFile && !this.btndisabledupload;
  }
}
