...
import { ImageService } from '../../service/image_service/image.service'; 
...
export class UploadImageComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    formData.append('fichier', this.selectedImage as File);
     

    console.log("test upload image",formData.get("fichier"));
    console.log("test upload image",formData.get("titre"));
    console.log("test upload image",formData.get("description"));
